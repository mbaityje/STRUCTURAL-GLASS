...
declare -A NSTEPS_LIST=( ["10.0"]=$(echo 0.5/$dt |bc) ["2.0"]=$(echo 5/$dt |bc) ["0.6"]=$(echo 2*10^5/$dt |bc) ["0.49"]=$(echo 1*10^7/$dt |bc) ["0.466"]=$(echo 1*10^8/$dt |bc) ["0.44"]=$(echo 5*10^8/$dt |bc) ["0.43"]=$(echo 5*10^9/$dt |bc) ["0.42"]=$(echo 1*10^10/$dt |bc))
