...
################################################################
#
# this tutorial calculates noise correlation function with Rotenberg's 
# forward algorithm J.Chem.Phys.140 124103(2014).
# System is a monodisperse Lennard Jones liquid.
#
# DESCRIPTION
# This example:
...
# 
# Launch as:
# python T16-OrthogonalCorrelationsRotenberg.py --user="-N1000 -t10000 --dt=0.001 --temperature=1.5 --seed=0 --tauT=0.1"
# 
################################################################
...
for ik in range(nk):
	...
	for itag in taglist:
		...
		B=np.zeros((Ncorr, args.Ntraj),dtype=np.float64)
		...
		#Correlation in Orthogonal Dynamics
