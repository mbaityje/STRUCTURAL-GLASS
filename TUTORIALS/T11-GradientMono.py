...
# calculates the gradient of the energy with a Kob-Andersen potential.
...
# python T11-GradientMono.py configuration.gsd
#
# For example:
# python T11-GradientMono.py sample-states/KA_rho=12e-1_N=1e3_T=45e-2_tag=1_type=restart.gsd
# python T11-GradientMono.py sample-states/N65.gsd
# 
################################################################
...
myLjPair.set_params(mode="no_shift")
...
def CalculateGradient(snapshot):
    ...
    for i in range(Natoms):
        for j in range(i+1,Natoms):
            ...
            energia+=Vpair(r, eps, sigma, r_cut)
            Vp=VpairPrime(r, eps, sigma, r_cut)
            temp=rvec*Vp
